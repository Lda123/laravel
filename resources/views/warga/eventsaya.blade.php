    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        @else
            <div class="col-span-full text-center py-12">
                ...
                <p class="text-lg text-gray-600 mb-4">Anda belum mendaftar pada event apapun.</p>
                <a href="{{ route('warga.dashboard') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200">
